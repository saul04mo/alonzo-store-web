        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-10 lg:gap-14">
          ...
          <div className="w-full md:w-[45%] md:sticky md:top-24 md:self-start page-fade-in">
            ...
            <div className="flex items-start justify-between gap-4">
              <h1 className="text-sm md:text-base font-sans tracking-[0.08em] uppercase font-semibold text-alonzo-charcoal leading-snug">
                {product.name}
              </h1>
              <div className="flex items-center gap-3 shrink-0">
                {hasOffer ? (
                  <p className="text-lg md:text-xl font-sans font-light text-red-600 whitespace-nowrap">
                    {cs()}{discountedPrice.toFixed(2)}
                  </p>
                ) : (
                  <p className="text-lg md:text-xl font-sans font-light text-alonzo-charcoal whitespace-nowrap">
            ...
            <div className="flex justify-end mt-3">
              <button
                ...
                className="px-4 py-2 border border-alonzo-gray-300 hover:border-alonzo-black text-[10px] font-sans tracking-[0.15em] uppercase font-medium text-alonzo-gray-600 hover:text-alonzo-black rounded-sm transition-colors duration-200"
              >
                Guía de tallas
              </button>
            </div>
